...
<div class="wrap">
  ...
  <div class="content">
    ...
    <div class="card">
      ...
      <div><span class="label">Failure Code</span><strong>{{ $notification->payload['failure_code'] ?? '—' }}</strong></div>
    </div>
    <a class="cta" href="{{ isset($t['id']) ? route('transfer.receipt',$t['id']) : route('dashboard') }}">Try Again</a>
  </div>
