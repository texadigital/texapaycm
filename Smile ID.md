...
Integration Options
Server to Server
RubyPythonJavaNode.jsPHP
PreviousRest APINextRuby
Last updated 1 year ago
...
Composer will install all dependencies into the vendor directory*.*
PreviousPHPNextSignature
Last updated 1 year ago
Installation | Smile ID
...
PreviousInstallationNextProducts
Last updated 1 year ago
Signature | Smile ID
...
Troubleshooting
Powered by GitBook
Running Document Verification on PHP
Get your Partner ID
Get your API Key
...
$image_details = array(
    ...
    array( // Optional, only use if you're uploading the back of the id document image
        "image_type_id" => <5 | 7>,
        "image" => "<full path to front of id document image or base64image string>"
    )
);
...
Interpret your Results
You can read more about result codes and responses in the Document Verification section of the docs.
...
54.246.37.255
99.81.237.141
PreviousWhat is document autocapture?NextHow to re-enroll, deactivate or delete a user?
Last updated 17 days ago
How do I set up a callback? | Smile ID
...
The return values, result codes and texts all remain the same as submitting the job with a selfie
PreviousDocument VerificationNextEnhanced Document Verification
Last updated 3 months ago
Document Verification | Smile ID
...
Web Integration
Installation
Include the Web Integration script on your website or web application. It should always be loaded directly from https://cdn.smileidentity.com.
Copy
<script src="https://cdn.smileidentity.com/inline/v2/js/script.min.js"></script>
PreviousWeb IntegrationNextUsage
Last updated 4 months ago
Installation | Smile ID
...
PreviousWeb / Mobile WebNextInstallation
Last updated 1 year ago
Web Integration | Smile ID
...
PreviousJavascript SDKNextUsage
Last updated 4 months ago
Installation | Smile ID
...
Electronic Signature
Upload documents for signatures by an individual, and allow the individual sign the documents. Link to documentation here.
PreviousUsing SignatureNextPostman Collection
Last updated 1 year ago
Products | Smile ID
...
Get the list of ID types and countries supported by Smile ID
Supported ID types
PreviousProductsNextRate Limits
Last updated 1 year ago
Postman Collection | Smile ID
...
2401
System error
PreviousPostman CollectionNextUtilities
Last updated 2 months ago
Rate Limits | Smile ID
...
PreviousRate LimitsNextWeb / Mobile Web
Last updated 1 year ago
Utilities | Smile ID
...
An array that takes the customer’s known nationalities in 2-character format e.g. Nigeria is NG, Kenya is KE, etc.
...
If you intend to re-use the name and year of birth of a user's previous KYC job, you can pass the boolean value set to true.
...
Deprecated - all adverse news is now returned in news_summary
...
The people[].adverse_media field has been deprecated.

All adverse news items are now returned in people[].news_summary[].

The people[].adverse_media field is no longer visible in the Portal.

The API still includes people[].adverse_media, but it is always an empty object.
